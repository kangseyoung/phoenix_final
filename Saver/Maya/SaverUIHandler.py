...
from Saver.Maya.get_maya_current_path import MayaCurrentPathImporter
...
class SaverUIHandler(QWidget):
    ...
    def store_save_info(self):  # 저장될 경로에 필요한 정보 저장
        ...
        if entity_type == "Assets":
            ...
            #asset_type_id저장이 안되는 것 같습니다!
            #샷그리드에서 에셋타임 네임으로 에셋 타입 조회해서 아이디 집어넣어 주거나 해야할 것 같어요.
    ...
    def setting(self):
        ui_file_path = "/home/rapa/_phoenix_/ui/saver_mockup_0829_1646.ui" 
